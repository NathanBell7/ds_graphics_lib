...
int main(){
  ...
  int sprite1 = spriteController->createNewSprite(true, SpriteSize_16x16, 50, 50, 1);
  spriteController->addPalette(0, true, blue_head_downPal, blue_head_downPalLen);
  spriteController->setSpritePaletteNumber(0, true, 0);
  spriteController->setSpriteTiles(0, true, blue_head_downTiles, blue_head_downTilesLen);
